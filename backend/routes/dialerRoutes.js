...
const { authorizeSession, completeCall, createOutcall, createSession, getDialerMessages, getNextCall, replyDialerMessage, updateStatus, uploadDialerRecording } = require('../controllers/dialerController')
